...
<div class="flex flex-col gap-6">
    <div class="space-y-2 text-center">
        <h1 class="text-2xl font-semibold tracking-tight text-white"><?php echo e(__('Log in to your account')); ?></h1>
        <p class="text-sm text-white/72"><?php echo e(__('Enter your username or email and password below to log in')); ?></p>
    </div>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('status') && session('status') !== __('Language switched successfully.')): ?>
    ...
    <form x-data class="flex flex-col gap-6" x-on:submit.prevent="$wire.login()">
        <div class="space-y-2.5">
            <label for="login" class="block text-sm font-medium" style="color: var(--theme-header-text-color);"><?php echo e(__('Username or email')); ?></label>
            <input
                id="login"
...
$message = $__bag->first($__errorArgs[0]); ?>
                <div class="text-sm font-medium" style="color: var(--theme-danger-color);"><?php echo e($message); ?></div>
            <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('password.request')): ?>
                <a href="<?php echo e(route('password.request')); ?>" class="absolute top-0 end-0 text-sm font-medium transition hover:opacity-90" style="color: var(--theme-link-color);" onmouseover="this.style.color='var(--theme-link-hover-color)'" onmouseout="this.style.color='var(--theme-link-color)'" wire:navigate>
        ...
        <label for="remember-1" class="group inline-flex cursor-pointer items-start gap-3">
            ...
            <span class="min-w-0 pt-0.5">
                <span class="block text-sm font-medium text-slate-200" style="color: var(--theme-header-text-color);"><?php echo e(__('Remember me')); ?></span>
            </span>
        </label>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(function_exists('captcha_enabled') && captcha_enabled()): ?>
            <?php echo $__env->make(theme_view('livewire.auth.partials.captcha', 'guest'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['captchaToken'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($socialProviders->isNotEmpty()): ?>
        <div class="space-y-4">
            <div class="flex items-center gap-3 text-xs uppercase tracking-[0.22em] text-white/60">
                <span class="h-px flex-1 bg-white/12"></span>
                <span><?php echo e(__('Or continue with')); ?></span>
                <span class="h-px flex-1 bg-white/12"></span>
            </div>
            ...
            <div class="grid w-full gap-3 grid-cols-1">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $socialProviders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $provider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <a
                        href="<?php echo e(url('auth/login/'.$provider['key'])); ?>"
                    ...
                    >
                        ...
                        <span><?php echo e($provider['label']); ?></span>
                    </a>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth_signup_enabled() && Route::has('register')): ?>
        <div class="space-x-1 text-sm text-center rtl:space-x-reverse text-white/70">
            <span><?php echo e(__("Don't have an account?")); ?></span>
            <a href="<?php echo e(route('register')); ?>" class="font-medium transition hover:opacity-90" style="color: var(--theme-link-color);" onmouseover="this.style.color='var(--theme-link-hover-color)'" onmouseout="this.style.color='var(--theme-link-color)'" wire:navigate><?php echo e(__('Sign up')); ?></a>
        </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div>
<?php /**PATH C:\Users\officialum1 llc\Downloads\codecanyon-stackposts-social-marketing-tool-v10.0.0-untouched\resources\themes\guest\default/resources/views/livewire/auth/login-page.blade.php ENDPATH**/ ?>