        ...
        >
            ...
            >
                <div class="flex items-center justify-between gap-4 lg:gap-6">
                    <a href="<?php echo e(route('home')); ?>" class="flex items-center transition hover:opacity-90">
                        <span class="flex h-11 w-11 shrink-0 items-center justify-center overflow-hidden rounded-[1rem] ring-1 ring-white/10 shadow-[0_0_30px_rgba(139,92,246,0.28)]" style="background: linear-gradient(135deg, rgba(139,92,246,0.88) 0%, rgba(79,70,229,0.92) 58%, rgba(34,211,238,0.84) 100%);">
                            <img src="<?php echo e(url(get_option('website_logo_light', 'public/img/logo-light.png'))); ?>" alt="<?php echo e($siteTitle); ?>" class="h-7 w-auto object-contain">
                        </span>
                    </a>
                        ...
                        <div class="guest-marketing-header-nav flex items-center gap-1 rounded-full border border-white/8 bg-white/[0.03] px-2 py-2 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $navItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <a
                                    ...
                                    x-bind:class="(() => {
                                        const itemKey = <?php echo \Illuminate\Support\Js::from($item['key'])->toHtml() ?>;
                                        const itemHash = <?php echo \Illuminate\Support\Js::from($item['hash'])->toHtml() ?>;
                                        const isFeatures = itemHash && currentHash === itemHash;
                                        const isHome = itemKey === 'home' && <?php echo \Illuminate\Support\Js::from(request()->routeIs('home'))->toHtml() ?> && currentHash !== '#capabilities';
                                        const isServerActive = <?php echo \Illuminate\Support\Js::from($item['active'])->toHtml() ?>;
                    ...
                    <div class="hidden items-center gap-2.5 lg:flex">
                        <?php echo $__env->make(theme_view('partials.appearance-toggle', 'guest'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($languages->isNotEmpty()): ?>
                            ...
                            <div x-data="{ open: false }" class="relative">
                                <button x-on:click="open = !open" x-on:click.outside="open = false" type="button" class="guest-marketing-action-button guest-marketing-locale-button inline-flex h-11 items-center gap-2 rounded-full border border-white/8 bg-white/[0.03] px-3.5 text-sm font-medium text-white/88 transition hover:bg-white/[0.05]">
                                    <span class="<?php echo e(language_flag_class($activeLanguage ?? app()->getLocale())); ?> rounded-sm text-[18px]"></span>
                                ...
                                <div x-cloak x-show="open" x-transition.origin.top.right class="guest-marketing-language-dropdown absolute right-0 z-30 mt-3 w-56 overflow-hidden rounded-[1.4rem] border border-white/10 bg-[linear-gradient(180deg,rgba(16,18,32,0.99)_0%,rgba(9,12,24,0.98)_100%)] p-2 shadow-[0_30px_80px_-34px_rgba(0,0,0,0.9)] backdrop-blur-xl">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        ...
                                        ?>
                                        <a href="<?php echo e(route('language.switch', $language->code)); ?>" class="guest-marketing-language-option no-theme-link <?php echo e($isActiveLanguage ? 'bg-emerald-500 text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]' : 'text-white/86 hover:bg-white/[0.05] hover:text-white'); ?> flex items-center gap-3 rounded-[1rem] px-3 py-3 text-sm font-medium transition">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(route('portal.dashboard')); ?>" class="guest-marketing-action-button guest-marketing-dashboard-button inline-flex h-11 items-center rounded-full border border-white/10 bg-white/[0.03] px-5 text-sm font-medium text-white/78 transition hover:bg-white/8 hover:text-white"><?php echo e(__('Dashboard')); ?></a>
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="guest-marketing-action-button inline-flex h-11 items-center rounded-full border border-white/10 bg-white/[0.03] px-5 text-sm font-medium text-white/72 transition hover:bg-white/8 hover:text-white"><?php echo e(__('Log in')); ?></a>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($signupEnabled): ?>
                                <a href="<?php echo e(route('register')); ?>" class="guest-marketing-action-button inline-flex h-11 items-center rounded-full px-5 text-sm font-semibold text-white shadow-[0_0_28px_rgba(99,102,241,0.32),0_20px_46px_-24px_rgba(34,211,238,0.45)] transition hover:scale-[1.01]" style="background: linear-gradient(135deg, #8b5cf6 0%, #4f46e5 52%, #22d3ee 100%);"><?php echo e(__('Get Started Free')); ?></a>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                ...
                <div x-cloak x-show="open" x-transition class="mt-4 space-y-4 border-t border-white/8 pt-4 lg:hidden">
                    <nav class="grid gap-2 text-sm font-medium text-white/70">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $navItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <a href="<?php echo e($item['href']); ?>" class="<?php echo e($item['active'] ? 'bg-white/[0.08] text-white' : 'hover:bg-white/5 hover:text-white'); ?> rounded-2xl px-3 py-2 transition"><?php echo e($item['label']); ?></a>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    </nav>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($languages->isNotEmpty()): ?>
                        <div class="grid gap-2">
                            <p class="px-1 text-[11px] font-semibold uppercase tracking-[0.18em] text-white/34"><?php echo e(__('Language')); ?></p>
                            <div class="grid gap-2 sm:grid-cols-2">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <?php
                                        $isActiveLanguage = app()->getLocale() === $language->code;
                                    ?>
                                    <a href="<?php echo e(route('language.switch', $language->code)); ?>" class="<?php echo e($isActiveLanguage ? 'bg-white/[0.08] text-white border-white/14' : 'text-white/72 border-white/10 hover:bg-white/[0.05] hover:text-white'); ?> inline-flex items-center gap-3 rounded-2xl border px-4 py-3 text-sm font-medium transition">
                                        <span class="<?php echo e(language_flag_class($language)); ?> rounded-sm text-[18px]"></span>
                                        <span><?php echo e($language->name ?? strtoupper((string) $language->code)); ?></span>
                                    </a>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            </div>
                        </div>
                    ...
                    <div class="grid gap-2 sm:grid-cols-2">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(route('portal.dashboard')); ?>" class="inline-flex items-center justify-center rounded-2xl border border-white/10 px-4 py-3 text-sm font-medium text-white/80"><?php echo e(__('Dashboard')); ?></a>
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="inline-flex items-center justify-center rounded-2xl border border-white/10 px-4 py-3 text-sm font-medium text-white/80"><?php echo e(__('Log in')); ?></a>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($signupEnabled): ?>
                                <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center justify-center rounded-2xl px-4 py-3 text-sm font-semibold text-white shadow-[0_0_24px_rgba(99,102,241,0.24)]" style="background: linear-gradient(135deg, #8b5cf6 0%, #4f46e5 52%, #22d3ee 100%);"><?php echo e(__('Get Started Free')); ?></a>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </div>
                ...
                <div class="grid gap-10 px-6 py-8 lg:grid-cols-[1.2fr_1.5fr_0.7fr] lg:px-8 lg:py-10">
                    <div class="relative max-w-md">
                        ...
                        <p class="mt-5 max-w-[19rem] text-[1.16rem] font-semibold leading-[1.22] tracking-[-0.02em] text-white lg:text-[1.24rem]">
                            <?php echo e(__('Create better content and publish with less manual work.')); ?>

                        </p>
                        <p class="mt-4 text-sm text-white/44"><?php echo e($siteTitle); ?>, <?php echo e(date('Y')); ?>.</p>
                    </div>

                    <div class="grid gap-8 sm:grid-cols-3">
                        <div>
                            <p class="text-[11px] font-semibold uppercase tracking-[0.18em] text-white/34"><?php echo e(__('Platform')); ?></p>
                            <div class="mt-4 grid gap-3 text-sm text-white/66">
                                <a href="<?php echo e(route('guest.pricing')); ?>" class="no-theme-link transition hover:text-white" style="color: inherit;"><?php echo e(__('Plans & Pricing')); ?></a>
                                <a href="<?php echo e(route('home')); ?>#capabilities" class="no-theme-link transition hover:text-white" style="color: inherit;"><?php echo e(__('Features')); ?></a>
                                <a href="<?php echo e(route('guest.contact')); ?>" class="no-theme-link transition hover:text-white" style="color: inherit;"><?php echo e(__('Contact')); ?></a>
                            </div>
                        </div>

                        <div>
                            <p class="text-[11px] font-semibold uppercase tracking-[0.18em] text-white/34"><?php echo e(__('Company')); ?></p>
                            <div class="mt-4 grid gap-3 text-sm text-white/66">
                                <a href="<?php echo e(route('guest.blogs')); ?>" class="no-theme-link transition hover:text-white" style="color: inherit;"><?php echo e(__('Blog')); ?></a>
                                <a href="<?php echo e(route('guest.faqs')); ?>" class="no-theme-link transition hover:text-white" style="color: inherit;"><?php echo e(__('FAQs')); ?></a>
                                <a href="<?php echo e(route('guest.contact')); ?>" class="no-theme-link transition hover:text-white" style="color: inherit;"><?php echo e(__('Support')); ?></a>
                            </div>
                        </div>

                        <div>
                            <p class="text-[11px] font-semibold uppercase tracking-[0.18em] text-white/34"><?php echo e(__('Resources')); ?></p>
                            <div class="mt-4 grid gap-3 text-sm text-white/66">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $footerLegal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <a href="<?php echo e($item['href']); ?>" class="no-theme-link transition hover:text-white" style="color: inherit;"><?php echo e($item['label']); ?></a>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($socialLinks->isNotEmpty()): ?>
                                    <a href="<?php echo e($socialLinks->first()['url']); ?>" target="_blank" rel="noopener noreferrer" class="no-theme-link transition hover:text-white" style="color: inherit;"><?php echo e(__('Social')); ?></a>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="lg:justify-self-end">
                        <p class="text-[11px] font-semibold uppercase tracking-[0.18em] text-white/34"><?php echo e(__('Get in touch')); ?></p>
                        <div class="mt-4 flex flex-col gap-3">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($contactEmail !== ''): ?>
                                <a href="mailto:<?php echo e($contactEmail); ?>" class="no-theme-link inline-flex items-center justify-center rounded-full border border-white/10 px-4 py-2.5 text-sm font-medium text-white/72 transition hover:bg-white/8 hover:text-white" style="color: inherit;"><?php echo e($contactEmail); ?></a>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($contactPhone !== ''): ?>
                                <a href="tel:<?php echo e(preg_replace('/\s+/', '', $contactPhone)); ?>" class="no-theme-link inline-flex items-center justify-center rounded-full border border-white/10 px-4 py-2.5 text-sm font-medium text-white/72 transition hover:bg-white/8 hover:text-white" style="color: inherit;"><?php echo e($contactPhone); ?></a>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($contactEmail === '' && $contactPhone === ''): ?>
                                <a href="<?php echo e(route('guest.contact')); ?>" class="no-theme-link inline-flex items-center justify-center rounded-full border border-white/10 px-4 py-2.5 text-sm font-medium text-white/72 transition hover:bg-white/8 hover:text-white" style="color: inherit;"><?php echo e(__('Contact us')); ?></a>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\Users\officialum1 llc\Downloads\codecanyon-stackposts-social-marketing-tool-v10.0.0-untouched\resources\themes\guest\default/resources/views/layouts/marketing.blade.php ENDPATH**/ ?>