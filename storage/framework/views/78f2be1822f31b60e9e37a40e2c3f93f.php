...
>
    <a
        ...
        class="relative <?php echo e($itemClasses); ?>"
        style="<?php echo e($itemStyle); ?>"
        aria-label="<?php echo e(__('Marketplace')); ?>"
        wire:navigate
    >
        ...
        <span
            ...
            style="display: none;"
            aria-label="<?php echo e(__('Checking marketplace updates...')); ?>"
        >
    ...
    >
        ...
        >
            ...
            <div id="admin-marketplace-header-tooltip-content" class="whitespace-nowrap"><?php echo e(__('Marketplace')); ?></div>
        </div>
    </div>
</div>

<?php if (! $__env->hasRenderedOnce('d4034404-1da7-42d5-ae2c-546bf5cae8e4')): $__env->markAsRenderedOnce('d4034404-1da7-42d5-ae2c-546bf5cae8e4'); ?>
    <script>
        window.adminMarketplaceHeaderUpdates = window.adminMarketplaceHeaderUpdates || {
            endpoint: <?php echo \Illuminate\Support\Js::from(route('admin-marketplace.dashboard.update-notice'))->toHtml() ?>,
            intervalId: null,
            marketplaceLabel: <?php echo \Illuminate\Support\Js::from(__('Marketplace'))->toHtml() ?>,
            updatesAvailableLabel: <?php echo \Illuminate\Support\Js::from(__('Updates available'))->toHtml() ?>,
            updateBadge(data) {
...
<?php endif; ?>
<?php /**PATH C:\Users\officialum1 llc\Downloads\codecanyon-stackposts-social-marketing-tool-v10.0.0-untouched\modules\AdminMarketplace\Providers/../Resources/views/partials/header-item.blade.php ENDPATH**/ ?>