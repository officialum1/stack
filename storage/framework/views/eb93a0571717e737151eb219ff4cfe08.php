...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '9b79a89ad06cf93f362f51a14dcd0300::ui.button','data' => ['type' => 'button','variant' => 'outline','onclick' => 'return window.adminNotificationsPanel.markAllRead();']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '9b79a89ad06cf93f362f51a14dcd0300::ui.button','data' => ['type' => 'button','variant' => 'outline','onclick' => 'return window.adminNotificationsPanel.archiveAll();']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
    ...
    <?php if (! $__env->hasRenderedOnce('ad559741-952d-4ca0-b8a8-b9bba3f5bc26')): $__env->markAsRenderedOnce('ad559741-952d-4ca0-b8a8-b9bba3f5bc26'); ?>
        <script>
...
<?php /**PATH C:\Users\officialum1 llc\Downloads\codecanyon-stackposts-social-marketing-tool-v10.0.0-untouched\modules\AdminNotifications\Providers/../Resources/views/partials/header-item-admin.blade.php ENDPATH**/ ?>