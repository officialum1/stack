            ...
            <div class="relative flex min-w-0 h-full flex-col justify-between gap-6 sm:gap-8">
                <div class="flex min-w-0 flex-wrap items-start justify-between gap-4">
                    ...
                    <div class="min-w-0 max-w-full rounded-[1rem] border px-4 py-3 text-left sm:text-right" style="border-color: rgba(var(--theme-border-color-rgb),0.46); background: color-mix(in srgb, var(--theme-surface-overlay) 82%, transparent);">
                        <p class="text-[10px] font-semibold uppercase tracking-[0.24em]" style="color: var(--theme-muted-text-color);"><?php echo e(__('Plan status')); ?></p>
                        <p class="mt-2 text-sm font-semibold" style="color: var(--theme-header-text-color);"><?php echo e($planName); ?></p>
                        <p class="mt-1 text-xs" style="color: var(--theme-muted-text-color);"><?php echo e($planExpiryLabel); ?></p>
                    </div>
                </div>
                ...
                <div class="min-w-0 max-w-[46rem]">
                    <p class="text-[2.1rem] font-semibold leading-[1.02] tracking-[-0.075em] sm:text-[2.7rem]" style="color: var(--theme-header-text-color);">
                        <?php echo e(__('Welcome, :name', ['name' => $user?->name ?: $user?->username ?: __('there')])); ?>

                    </p>
                    <p class="mt-4 max-w-[38rem] text-[15px] leading-7" style="color: var(--theme-muted-text-color);">
                        <?php echo e(__("Here's your control surface for plan health, credits, and account readiness before you jump back into work.")); ?>
                ...
                <div class="grid min-w-0 gap-3 md:grid-cols-3">
                    <div class="rounded-[1.1rem] border px-4 py-4" style="border-color: rgba(var(--theme-accent-rgb,37,99,235),0.14); background: color-mix(in srgb, var(--theme-surface-overlay) 84%, transparent);">
                        <p class="text-[10px] font-semibold uppercase tracking-[0.22em]" style="color: var(--theme-muted-text-color);"><?php echo e(__('Current plan')); ?></p>
                        <p class="mt-3 text-[1.25rem] font-semibold tracking-[-0.04em]" style="color: var(--theme-header-text-color);"><?php echo e($planName); ?></p>
                        <p class="mt-1 text-sm" style="color: var(--theme-muted-text-color);"><?php echo e(__('Active package attached to this portal.')); ?></p>
                    </div>
                    ...
                    <div class="rounded-[1.1rem] border px-4 py-4" style="border-color: rgba(var(--theme-success-color-rgb),0.18); background: color-mix(in srgb, var(--theme-surface-overlay) 84%, rgba(var(--theme-success-color-rgb),0.04));">
                        <p class="text-[10px] font-semibold uppercase tracking-[0.22em]" style="color: var(--theme-muted-text-color);"><?php echo e(__('Access window')); ?></p>
                        <p class="mt-3 text-[1.25rem] font-semibold tracking-[-0.04em]" style="color: var(--theme-header-text-color);">
                            <?php echo e($user?->isInPlanTrial() ? __('Trial') : __('Live')); ?>

                        </p>
                        <p class="mt-1 text-sm" style="color: var(--theme-muted-text-color);">
                            <?php echo e($user?->isInPlanTrial()
                    ...
                    <div class="rounded-[1.1rem] border px-4 py-4" style="border-color: rgba(var(--theme-border-color-rgb),0.46); background: color-mix(in srgb, var(--theme-surface-overlay) 84%, transparent);">
                        <p class="text-[10px] font-semibold uppercase tracking-[0.22em]" style="color: var(--theme-muted-text-color);"><?php echo e(__('Workspace signal')); ?></p>
                        <p class="mt-3 text-[1.25rem] font-semibold tracking-[-0.04em]" style="color: var(--theme-success-color);"><?php echo e(__('Ready to publish')); ?></p>
                        <p class="mt-1 text-sm" style="color: var(--theme-muted-text-color);"><?php echo e(__('Account, plan, and credits are visible from one panel.')); ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="relative min-w-0 space-y-5">
                <div class="flex min-w-0 flex-wrap items-start justify-between gap-4">
                    <div class="flex min-w-0 items-start gap-4">
                        ...
                        <div class="min-w-0">
                            <p class="text-[11px] font-semibold uppercase tracking-[0.22em]" style="color: var(--theme-muted-text-color);"><?php echo e(__('Your Credits')); ?></p>
                            <p class="mt-2 text-[2.15rem] font-semibold leading-none tracking-[-0.075em] sm:text-[2.65rem]" style="color: var(--theme-header-text-color);">
                                <?php echo e($creditRemainingLabel); ?>
                    ...
                    <span class="inline-flex max-w-full items-center rounded-full px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.16em]" style="background: rgba(var(--theme-warning-color-rgb),0.10); color: var(--theme-warning-color);">
                        <?php echo e($credits['unlimited'] ? __('Unlimited') : __('Credit balance')); ?>

                    </span>
                </div>

                <p class="max-w-[24rem] text-sm leading-6" style="color: var(--theme-muted-text-color);">
                    <?php echo e($credits['unlimited']
                ...
                <div class="grid min-w-0 gap-3 sm:grid-cols-2">
                    <div class="rounded-[1.05rem] border px-4 py-4" style="border-color: rgba(var(--theme-border-color-rgb),0.5); background: color-mix(in srgb, var(--theme-surface-overlay) 84%, transparent);">
                        <p class="text-[10px] font-semibold uppercase tracking-[0.22em]" style="color: var(--theme-muted-text-color);"><?php echo e(__('Used')); ?></p>
                        <p class="mt-3 text-[1.6rem] font-semibold tracking-[-0.045em]" style="color: var(--theme-header-text-color);"><?php echo e(number_format((int) $credits['used'])); ?></p>
                        <p class="mt-1 text-xs leading-5" style="color: var(--theme-muted-text-color);"><?php echo e(__('Credits already consumed')); ?></p>
                    </div>
                    ...
                    <div class="rounded-[1.05rem] border px-4 py-4" style="border-color: rgba(var(--theme-success-color-rgb),0.18); background: linear-gradient(180deg, rgba(var(--theme-success-color-rgb),0.10), color-mix(in srgb, var(--theme-surface-overlay) 84%, transparent));">
                        <p class="text-[10px] font-semibold uppercase tracking-[0.22em]" style="color: var(--theme-muted-text-color);"><?php echo e(__('Available')); ?></p>
                        <p class="mt-3 text-[1.6rem] font-semibold tracking-[-0.045em]" style="color: var(--theme-success-color);"><?php echo e($creditRemainingLabel); ?></p>
                        <p class="mt-1 text-xs leading-5" style="color: var(--theme-muted-text-color);"><?php echo e(__('Still ready to use')); ?></p>
                    </div>
                </div>
                ...
                <div class="min-w-0 rounded-[1.05rem] border px-4 py-4" style="border-color: rgba(var(--theme-border-color-rgb),0.46); background: color-mix(in srgb, var(--theme-surface-overlay) 78%, transparent);">
                    <div class="flex min-w-0 items-center justify-between gap-4">
                        <div>
                            <p class="text-[10px] font-semibold uppercase tracking-[0.22em]" style="color: var(--theme-muted-text-color);"><?php echo e(__('Usage')); ?></p>
                            <p class="mt-2 text-lg font-semibold tracking-[-0.03em]" style="color: var(--theme-header-text-color);"><?php echo e($usagePercent); ?>%</p>
                        </div>
                        <div class="min-w-0 text-right text-xs" style="color: var(--theme-muted-text-color);">
                            <p><?php echo e(__('Used: :count', ['count' => number_format((int) $credits['used'])])); ?></p>
                            <p class="mt-1"><?php echo e($credits['unlimited'] ? __('Unlimited available') : __(':count left', ['count' => $creditRemainingLabel])); ?></p>
                        </div>
                    </div>

                    <div class="mt-4 h-3 overflow-hidden rounded-full" style="background: rgba(var(--theme-border-color-rgb),0.26);">
                        <div class="h-full rounded-full" style="width: <?php echo e(max(4, $usagePercent)); ?>%; background: linear-gradient(90deg, #f59e0b 0%, #f97316 36%, rgba(var(--theme-accent-rgb,37,99,235),0.88) 100%); box-shadow: 0 0 18px rgba(245,158,11,0.22);"></div>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\Users\officialum1 llc\Downloads\codecanyon-stackposts-social-marketing-tool-v10.0.0-untouched\modules\AppProfile\Providers/../Resources/views/dashboard/welcome.blade.php ENDPATH**/ ?>