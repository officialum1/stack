...
<title>
    <?php echo e(filled($title ?? null) ? $title.' - '.$siteTitle : $siteTitle); ?>

</title>

<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($gaEnabled && $gaTrackGuest && $gaMeasurementId !== ''): ?>
...
<?php echo $__env->make(theme_view('partials.embed-code-head', 'guest'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<style>
    ...
    html[data-theme-resolved='dark'] {
        --theme-accent: <?php echo e(theme_setting('accent_color', 'guest', '#8b5cf6')); ?>;
        --theme-accent-rgb: <?php echo e(theme_accent_rgb('guest')); ?>;
        --theme-body-bg: <?php echo e(theme_setting('body_bg_color', 'guest', '#070814')); ?>;
        --theme-body-bg-rgb: <?php echo e(theme_color_rgb('body_bg_color', 'guest', '#070814')); ?>;
        --theme-surface-bg: <?php echo e(theme_setting('surface_bg_color', 'guest', '#0f1224')); ?>;
        --theme-surface-bg-rgb: <?php echo e(theme_color_rgb('surface_bg_color', 'guest', '#0f1224')); ?>;
        --theme-header-bg: <?php echo e(theme_setting('header_bg_color', 'guest', '#0c1020')); ?>;
        --theme-header-bg-rgb: <?php echo e(theme_color_rgb('header_bg_color', 'guest', '#0c1020')); ?>;
        --theme-header-active: <?php echo e(theme_setting('header_active_color', 'guest', '#f8fafc')); ?>;
        --theme-header-active-rgb: <?php echo e(theme_color_rgb('header_active_color', 'guest', '#f8fafc')); ?>;
        --theme-header-text-color: <?php echo e(theme_setting('header_text_color', 'guest', '#f8fafc')); ?>;
        --theme-link-color: <?php echo e(theme_setting('link_color', 'guest', '#8b5cf6')); ?>;
        --theme-link-hover-color: <?php echo e(theme_setting('link_hover_color', 'guest', '#22d3ee')); ?>;
        --theme-border-color: <?php echo e(theme_setting('border_color', 'guest', '#1f2440')); ?>;
        --theme-muted-text-color: <?php echo e(theme_setting('muted_text_color', 'guest', '#aab6d3')); ?>;
        --theme-success-color: <?php echo e(theme_setting('success_color', 'guest', '#059669')); ?>;
        --theme-warning-color: <?php echo e(theme_setting('warning_color', 'guest', '#d97706')); ?>;
        --theme-danger-color: <?php echo e(theme_setting('danger_color', 'guest', '#dc2626')); ?>;
        ...
        --theme-font-sans: <?php echo theme_font_stack('guest'); ?>;
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(filled(theme_setting('custom_css', 'guest'))): ?>
    <style><?php echo theme_setting('custom_css', 'guest'); ?></style>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<script>
    (() => {
        ...
        const supportsDark = <?php echo \Illuminate\Support\Js::from((string) theme_setting('supports_dark_mode', 'guest', '1'))->toHtml() ?> !== '0';
        const allowToggle = <?php echo \Illuminate\Support\Js::from((string) theme_setting('allow_user_appearance_toggle', 'guest', '1'))->toHtml() ?> !== '0';
        const defaultMode = <?php echo \Illuminate\Support\Js::from(theme_setting('default_appearance', 'guest', theme_setting('appearance', 'guest', 'dark')))->toHtml() ?>;
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(filled(theme_setting('custom_js', 'guest'))): ?>
    <script><?php echo theme_setting('custom_js', 'guest'); ?></script>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php echo theme_vite('guest', ['assets/js/app.js', 'resources/themes/shared/js/highcharts.js', 'resources/themes/shared/js/image-editor.js']); ?>

<?php /**PATH C:\Users\officialum1 llc\Downloads\codecanyon-stackposts-social-marketing-tool-v10.0.0-untouched\resources\themes\guest\default/resources/views/partials/head.blade.php ENDPATH**/ ?>