...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        <?php echo $__env->make(theme_view('partials.head', 'guest'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                ...
                <div class="flex flex-1 items-center justify-center">
                    <div class="w-full max-w-[34rem]">
                        <div class="mx-auto mb-8 flex w-full max-w-[34rem] items-start justify-between gap-4">
                            <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-4 text-white/80 transition hover:text-white" wire:navigate>
                                <img src="<?php echo e($resolvedAuthLogoDark); ?>" alt="<?php echo e(config('app.name', 'StackPosts')); ?>" class="auth-brand-logo-dark block h-11 w-auto object-contain" onerror="this.onerror=null;this.src='<?php echo e($fallbackAuthLogoDark); ?>';">
                                <img src="<?php echo e($resolvedAuthLogoLight); ?>" alt="<?php echo e(config('app.name', 'StackPosts')); ?>" class="auth-brand-logo-light block h-11 w-auto object-contain" onerror="this.onerror=null;this.src='<?php echo e($fallbackAuthLogoLight); ?>';">
                            </a>
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <?php echo $__env->make(theme_view('partials.auth-language-switcher', 'guest'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            </div>
                        </div>
...
<?php /**PATH C:\Users\officialum1 llc\Downloads\codecanyon-stackposts-social-marketing-tool-v10.0.0-untouched\resources\themes\guest\default/resources/views/layouts/auth.blade.php ENDPATH**/ ?>