...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($supportsDark && $allowToggle): ?>
    <div
        x-data="{
    ...
    >
        <button
            ...
            title="<?php echo e(__('Light mode')); ?>"
        >
        ...
        <button
            ...
            title="<?php echo e(__('Dark mode')); ?>"
        >
            <i class="fa-light fa-moon-stars text-sm"></i>
        </button>
    </div>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php /**PATH C:\Users\officialum1 llc\Downloads\codecanyon-stackposts-social-marketing-tool-v10.0.0-untouched\resources\themes\guest\default/resources/views/partials/appearance-toggle.blade.php ENDPATH**/ ?>