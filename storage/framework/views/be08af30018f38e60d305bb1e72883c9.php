...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '9b79a89ad06cf93f362f51a14dcd0300::ui.dashboard-module','data' => ['eyebrow' => __('Communications'),'title' => null,'description' => null]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '9b79a89ad06cf93f362f51a14dcd0300::ui.chart','data' => ['title' => __('Notification workload'),'description' => __('Relative weight between campaigns, broadcasts, deliveries, and unread notifications.'),'type' => 'bar','categories' => [__('Campaigns'), __('Global'), __('Deliveries'), __('Unread')],'series' => $notificationSeries,'height' => 320]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\officialum1 llc\Downloads\codecanyon-stackposts-social-marketing-tool-v10.0.0-untouched\modules\AdminNotifications\Providers/../Resources/views/dashboard/snapshot.blade.php ENDPATH**/ ?>