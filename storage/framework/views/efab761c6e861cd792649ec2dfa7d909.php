...
<div class="<?php echo e($class); ?>">
    <div
        ...
        x-data="{
            ...
            ensureLibrary() {
                ...
                window.__stackpostsHighchartsLoader = new Promise((resolve, reject) => {
                    ...
                    script.src = <?php echo \Illuminate\Support\Js::from($fallbackScriptUrl)->toHtml() ?>;
                    script.async = true;
        ...
        x-init="
            ...
            bindLivewire();
        "
        style="width: 100%; height: <?php echo e($resolvedHeight); ?>;"
    >
...
<?php /**PATH C:\Users\officialum1 llc\Downloads\codecanyon-stackposts-social-marketing-tool-v10.0.0-untouched\resources\themes/shared/views/components/highchart.blade.php ENDPATH**/ ?>