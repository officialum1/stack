...
<head>
    @php
        $optionStore = app(\Modules\AdminSettings\Support\OptionStore::class);
        $siteTitle = trim((string) $optionStore->get('website_title', ''));
        $siteDescription = trim((string) $optionStore->get('website_description', ''));
        $siteKeywords = trim((string) $optionStore->get('website_keyword', ''));

        $siteTitle = $siteTitle !== '' ? $siteTitle : config('site.title');
        $siteDescription = $siteDescription !== '' ? $siteDescription : config('site.description');
        $siteKeywords = $siteKeywords !== '' ? $siteKeywords : config('site.keywords');
    @endphp
    <title>
