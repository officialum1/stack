...
@php
    $emojiGroups = [
        ...
        ['key' => 'food', 'title' => __('Food & Drink'), 'icon' => '🍕', 'items' => ['🍏', '🍎', '🍐', '🍊', '🍋', '🍌', '🍉', '🍇', '🍓', '🫐', '🍒', '🍑', '🥭', '🍍', '🥥', '🥝', '🍅', '🥑', '🥦', '🥬', '🥒', '🌶️', '🫑', '🌽', '🥕', '🫒', '🧄', '🧅', '🥔', '🍠', '🥐', '🍞', '🥖', '🫓', '🥨', '🧀', '🥚', '🍳', '🧈', '🥞', '🧇', '🥓', '🍔', '🍟', '🍕', '🌭', '🥪', '🌮', '🌯', '🫔', '🥗', '🍝', '🍜', '🍲', '🍛', '🍣', '🍤', '🍱', '🥟', '🍦', '🍩', '🍪', '🎂', '🍰', '🧁', '🍫', '🍬', '🍿', '☕', '🍵', '🧃', '🥤', '🍺', '🍷', '🍸']],
        ['key' => 'travel', 'title' => __('Travel & Places'), 'icon' => '✈️', 'items' => ['🚗', '🚕', '🚙', '🚌', '🚎', '🏎️', '🚓', '🚑', '🚒', '🚚', '🚜', '🛵', '🏍️', '🚲', '✈️', '🛫', '🛬', '🚀', '🛸', '🚁', '⛵', '🚤', '🛳️', '🚢', '🏠', '🏡', '🏢', '🏭', '🏬', '🏰', '🗼', '🗽', '⛪', '🕌', '🛕', '⛩️', '🏖️', '🏝️', '🏞️', '🌋', '⛰️', '🏔️', '🗻', '🏕️', '🏟️', '🎡', '🎢', '🌁', '🌃', '🌆', '🌇', '🌉', '🌌', '🎑']],
        ['key' => 'activity', 'title' => __('Activity'), 'icon' => '⚽', 'items' => ['⚽', '🏀', '🏈', '⚾', '🥎', '🎾', '🏐', '🏉', '🥏', '🎱', '🏓', '🏸', '🥊', '🥋', '🎯', '⛳', '🎣', '🤿', '🎽', '🛹', '🛷', '⛸️', '🥌', '🎿', '⛷️', '🏂', '🪂', '🏋️', '🤸', '⛹️', '🤾', '🏌️', '🧘', '🏄', '🏊', '🤽', '🚴', '🎮', '🕹️', '🎲', '♟️', '🎨', '🎭', '🎤', '🎧', '🎼', '🎹', '🥁', '🎷', '🎸', '🎻', '🎬', '📸']],
        ['key' => 'objects', 'title' => __('Objects'), 'icon' => '💡', 'items' => ['⌚', '📱', '💻', '⌨️', '🖥️', '🖨️', '🖱️', '📷', '📹', '🎥', '📞', '☎️', '📺', '📻', '⏰', '⏳', '📡', '🔋', '🔌', '💡', '🔦', '🕯️', '🧯', '💸', '💵', '💴', '💶', '💷', '🪙', '💳', '💎', '⚖️', '🔧', '🔨', '⚒️', '🛠️', '⛏️', '🪓', '🔩', '⚙️', '🧰', '🧲', '🪜', '🧪', '🧫', '🧬', '💉', '💊', '🩹', '📌', '📍', '✂️', '🖊️', '🖍️', '📝', '📚', '📦', '📅', '🗑️', '🔒', '🔓', '❤️', '💔', '⭐', '🌟', '✨', '✅', '❌', '⚠️', '🚫', '❗', '❓']],
        ['key' => 'symbols', 'title' => __('Symbols'), 'icon' => '🔣', 'items' => ['❤️', '🧡', '💛', '💚', '💙', '💜', '🖤', '🤍', '🤎', '💯', '💢', '💬', '💭', '♻️', '⚜️', '🔱', '⭕', '✅', '☑️', '✔️', '❌', '❎', '➕', '➖', '➗', '✖️', '〰️', '➰', '➿', '❗', '❕', '❓', '❔', '‼️', '⁉️', '🔴', '🟠', '🟡', '🟢', '🔵', '🟣', '⚫', '⚪', '🟤', '🔶', '🔷', '🔸', '🔹']],
        ['key' => 'flags', 'title' => __('Flags'), 'icon' => '🏳️', 'items' => ['🏳️', '🏴', '🏁', '🚩', '🏳️‍🌈', '🏳️‍⚧️', '🇺🇸', '🇬🇧', '🇻🇳', '🇯🇵', '🇰🇷', '🇨🇳', '🇫🇷', '🇩🇪', '🇮🇹', '🇪🇸', '🇧🇷', '🇮🇳', '🇸🇬', '🇹🇭', '🇮🇩', '🇵🇭', '🇲🇾', '🇦🇺', '🇨🇦']],
    ];

    $textareaClasses = 'flex min-h-32 w-full border px-4 py-3.5 text-sm leading-6 shadow-[0_1px_2px_rgba(15,23,42,0.04)] outline-none transition duration-200 placeholder:text-[var(--theme-input-placeholder)] focus:border-[var(--theme-accent)] focus:ring-4 focus:ring-[color:rgba(var(--theme-accent-rgb),0.10)]';

    if ($triggerPosition === 'inside-top-right') {
        $textareaClasses .= ' pr-16';
    }
@endphp
...
>
    ...
    <div class="space-y-3">
        <div class="relative">
            <textarea
                x-ref="textarea"
                {{ $attributes->merge(['style' => 'border-radius: var(--theme-input-radius, 0.75rem); border-color: var(--theme-border-color); background-color: var(--theme-input-surface); color: var(--theme-input-text);'])->except('class')->class($textareaClasses) }}
            >{{ $slot }}</textarea>

            @if ($triggerPosition === 'inside-top-right')
                <div class="absolute right-3 top-3 z-10" x-on:click.outside="pickerOpen = false">
                    <x-ui.button x-ref="triggerButton" type="button" variant="outline" size="sm" class="!h-10 !w-10 !rounded-full !p-0" x-on:click="togglePicker()" :title="__('Emoji')">
        ...
        @if (! in_array($triggerPosition, ['inside-top-right', 'outside-top-right'], true))
