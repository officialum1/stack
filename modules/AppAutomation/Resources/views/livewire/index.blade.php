        ...
        <div class="space-y-6">
            <x-ui.card class="overflow-hidden p-0">
                ...
                <div class="space-y-3 px-6 py-6 sm:px-8">
                    @forelse ($logs as $log)
                        <div class="rounded-[1rem] border px-4 py-4" style="border-color: rgba(var(--theme-border-color-rgb), 0.68); background-color: rgba(var(--theme-surface-base-rgb,255,255,255),0.95);" wire:key="automation-log-{{ $log->id }}">
