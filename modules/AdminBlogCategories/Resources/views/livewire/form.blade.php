            ...
            <x-ui.form-layout>
                <x-slot:main>
                    ...
                    @foreach ($languages as $language)
                        ...
                        <x-ui.locale-card :title="$name" :locale="$code" :default="$code === $defaultLocale">
                            ...
                            <x-ui.emoji-textarea
                                wire:model="descriptionTranslations.{{ $code }}"
                                :label="__('Description')"
                                :error="$errors->first('descriptionTranslations.'.$code)"
                                rows="4"
                                picker-position="top"
                                picker-align="right"
                ...
                <x-slot:sidebar>
                    ...
                    <x-ui.settings-panel class="space-y-4">
                        ...
                        />
                        <x-ui.input wire:model.defer="sortOrder" type="number" min="0" :label="__('Sort order')" :error="$errors->first('sortOrder')" />
