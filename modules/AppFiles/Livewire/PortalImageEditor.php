...
#[Title('Edit image')]
class PortalImageEditor extends Component
{
    ...
    public function mount(Request $request, AppFile $file): void
    {
        ...
        $this->file = $file;
        $this->previewUrl = route('portal.files.preview', $file);
        $this->saveUrl = route('portal.files.update-image', ['file' => $file, 'return' => $request->query('return')]);
